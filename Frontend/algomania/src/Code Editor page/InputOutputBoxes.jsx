...
const InputOutputBoxes = ({ darkMode, input, setInput, output, setOutput }) => {
  ...
  return (
    <div className="grid grid-rows-2 gap-0">
      ...
      {/* Output Box */}
      <div className={`p-4 rounded-lg shadow ${darkMode ? 'bg-[#272822] border border-gray-400 mt-0' : 'bg-[#f8f8f2] border border-gray-800 mt-0'}`}>
        <div className="flex items-center justify-between mb-4">
